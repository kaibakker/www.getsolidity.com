...
export default ({url}) => {
  return <Web3Container address={url.query.address} web3={false}
    ...
    render={({contract}) => { return <API abi={contract.abi} name={contract.contractName}  contract={contract} implementation={"seth"} type={"contracts/seth"} address={ contract.contractName } /> } }
  />
}
