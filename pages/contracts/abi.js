...
export default ({url}) => {
  return <Web3Container address={url.query.address} web3={false}
    ...
    render={({contract}) => { return <API abi={contract.abi} name={contract.contractName} contract={contract} implementation={"abi"} type={"contracts/abi"} address={ contract.contractName} /> } }
  />
}
